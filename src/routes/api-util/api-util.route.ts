...
import { alarmRouter } from "./alarm/alarm.route";
import { player_infoRouter } from "./player_info/player_info.route";
...
api_utilsRouter.use("/player_info", asyncHandler(player_infoRouter));
...
api_utilsRouter.use("/alarm", asyncHandler(alarmRouter))